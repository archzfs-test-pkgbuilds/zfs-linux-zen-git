...
pkgrel=1
makedepends=("linux-zen-headers=4.17.8-1" "git")
arch=("x86_64")
...
license=("CDDL")
depends=("kmod" "zfs-utils-common-git=2018.07.24.r4643.g473c976a0" "linux-zen=4.17.8-1")
...
package_zfs-linux-zen-git-headers() {
    ...
    sed -i "s+${srcdir}++" ${pkgdir}/usr/src/zfs-*/4.17.8-1-zen/Module.symvers
}
