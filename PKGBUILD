...
pkgrel=1
makedepends=("linux-zen-headers=4.14.14-1" "git" "spl-linux-zen-git-headers")
arch=("x86_64")
url="http://zfsonlinux.org/"
source=("git+https://github.com/zfsonlinux/zfs.git#commit=6bc4a2376c694f813d2ee78af3d749aa2684f391")
sha256sums=("SKIP")
license=("CDDL")
depends=("kmod" "spl-linux-zen-git" "zfs-utils-common-git=2018.01.19.r3252.6bc4a2376" "linux-zen=4.14.14-1")
...
package_zfs-linux-zen-git-headers() {
    ...
    sed -i "s+${srcdir}++" ${pkgdir}/usr/src/zfs-*/4.14.14-1-zen/Module.symvers
}
