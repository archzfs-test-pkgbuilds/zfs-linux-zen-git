...
pkgrel=1
makedepends=("linux-zen-headers=4.15.8-1" "git" "spl-linux-zen-git-headers")
arch=("x86_64")
url="http://zfsonlinux.org/"
source=("git+https://github.com/zfsonlinux/zfs.git#commit=743253df70e9d9772cf98fcdd0fb7f42398d4ff8")
sha256sums=("SKIP")
license=("CDDL")
depends=("kmod" "spl-linux-zen-git" "zfs-utils-common-git=2018.03.09.r3363.743253df7" "linux-zen=4.15.8-1")
...
package_zfs-linux-zen-git-headers() {
    ...
    sed -i "s+${srcdir}++" ${pkgdir}/usr/src/zfs-*/4.15.8-1-zen/Module.symvers
}
