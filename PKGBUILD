...
pkgrel=1
makedepends=("linux-zen-headers=4.15.12-1" "git" "spl-linux-zen-git-headers")
arch=("x86_64")
url="http://zfsonlinux.org/"
source=("git+https://github.com/zfsonlinux/zfs.git#commit=157ef7f6a527239e3cb3afa3be2acf502794a5d4")
sha256sums=("SKIP")
license=("CDDL")
depends=("kmod" "spl-linux-zen-git" "zfs-utils-common-git=2018.03.23.r3384.157ef7f6a" "linux-zen=4.15.12-1")
...
package_zfs-linux-zen-git-headers() {
    ...
    sed -i "s+${srcdir}++" ${pkgdir}/usr/src/zfs-*/4.15.12-1-zen/Module.symvers
}
