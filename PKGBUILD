...
pkgrel=1
makedepends=("linux-zen-headers=4.16.8-1" "git" "spl-linux-zen-git-headers")
arch=("x86_64")
url="http://zfsonlinux.org/"
source=("git+https://github.com/zfsonlinux/zfs.git#commit=43eb39d6ccd8fbaa5ae3a84a6df549331db4d6be")
sha256sums=("SKIP")
license=("CDDL")
depends=("kmod" "spl-linux-zen-git" "zfs-utils-common-git=2018.05.15.r3487.g43eb39d6c" "linux-zen=4.16.8-1")
...
package_zfs-linux-zen-git-headers() {
    ...
    sed -i "s+${srcdir}++" ${pkgdir}/usr/src/zfs-*/4.16.8-1-zen/Module.symvers
}
