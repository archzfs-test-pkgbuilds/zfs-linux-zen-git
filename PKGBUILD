...
pkgrel=1
makedepends=("linux-zen-headers=4.17.10-1" "git")
arch=("x86_64")
...
license=("CDDL")
depends=("kmod" "zfs-utils-common-git=2018.07.27.r4648.gfb7307b89" "linux-zen=4.17.10-1")
...
build() {
    ...
    ./configure --prefix=/usr --sysconfdir=/etc --sbindir=/usr/bin --libdir=/usr/lib \
                ...
                --with-linux=/usr/lib/modules/4.17.10-1-zen/build \
                --with-linux-obj=/usr/lib/modules/4.17.10-1-zen/build
    make
}
...
package_zfs-linux-zen-git-headers() {
    ...
    sed -i "s+${srcdir}++" ${pkgdir}/usr/src/zfs-*/4.17.10-1-zen/Module.symvers
}
